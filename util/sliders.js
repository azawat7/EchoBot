...
module.exports = (client) => {
  ...
  class TextChannel extends Structures.get("TextChannel") {
    async createSlider(message, embeds, emojiNext, emojiBack) {
      const button_back = new MessageButton().setStyle("blurple").setID("back");

      const button_next = new MessageButton().setStyle("blurple").setID("next");
